...
public class Cron4j {
    ...
    public static final String EVERY_DAY_AT_10_AM = "0 10 * * *"; // for thoughts checking, should check already produced thoughts (maybe de-schedule if there were some)
    ...
    public static final String EVERY_WEEK_SUNDAY_18_PM = "0 18 * * 7"; // weekly results
